...
# Система прогнозирования сроков и стоимости наружных ремонтных работ

## Описание
Проект предназначен для автоматизированного сбора, анализа и прогнозирования параметров строительных закупок на основе данных с портала zakupki.gov.ru и исторических данных подрядных организаций.
